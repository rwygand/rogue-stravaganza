...
impl Plugin for ActionsPlugin {
    fn build(&self, app: &mut App) {
        app.init_resource::<ActorQueue>()
            ...
            .add_system(systems::populate_actor_queue.in_schedule(OnExit(GameState::PlayerInput)))
            .add_systems((systems::plan_walk, systems::plan_melee).in_set(ActionSet::Planning));
    }
}
